            ...
            if not file_exists(image_file_path) then
                ...
                if pu_config.format == "svg" then
                    ...
                    if f then
                        ...
                        f:close()
                        content = string.gsub(content, 'font%-family="sans%-serif"', "font-family=\"'Meiryo UI', 'Segoe UI', 'Hiragino Kaku Gothic ProN', 'ヒラギノ角ゴ ProN', 'Noto Sans JP', 'UDEV Gothic HSRFJPDOC', 'Helvetica Neue', Helvetica, Arial, sans-serif\"")
